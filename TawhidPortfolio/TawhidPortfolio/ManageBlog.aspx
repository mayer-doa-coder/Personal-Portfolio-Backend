<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageBlog.aspx.cs" Inherits="TawhidPortfolio.ManageBlog" ValidateRequest="false" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Blog Post</title>
        ...
        <div class="container">
            ...
            <div class="header">
                <h1>
                    ...
                    <asp:Literal ID="litPageTitle" runat="server" Text="Add New Blog Post"></asp:Literal>
                </h1>
            </div>
            ...
            <div class="form-group">
                <label for="txtTitle">Blog Title <span class="required">*</span></label>
                <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" placeholder="Enter blog post title"></asp:TextBox>
            ...
            <div class="form-group">
                <label for="txtContent">Content <span class="required">*</span></label>
                <asp:TextBox ID="txtContent" runat="server" 
                    TextMode="MultiLine" 
                    CssClass="form-control content" 
                    placeholder="Enter the full blog post content (HTML supported)"></asp:TextBox>
            ...
            <div class="form-group">
                <label for="txtImageUrl">Featured Image URL</label>
                <asp:TextBox ID="txtImageUrl" runat="server" 
                    CssClass="form-control" 
                    placeholder="Enter image URL (e.g., assets/images/blog-image.jpg)"></asp:TextBox>
            </div>
